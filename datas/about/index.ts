...
export const aboutData: AboutData = {
  ...
  timeline: [
    {
      ...
      period: "2021 - Present",
      description: "Currently working as a senior developer at TechFusion, leading the front-end development team and implementing cutting-edge technologies for various client projects."
    },
    {
      title: "Full Stack Developer",
      period: "2018 - 2021",
      description: "Worked as a full stack developer at WebCraft, responsible for developing and maintaining web applications using React, Node.js, and various database technologies."
    },
    {
      title: "UI/UX Designer",
      period: "2016 - 2018",
      description: "Began my career as a UI/UX designer at DesignHub, where I created user interfaces and experiences for mobile and web applications."
    },
    {
  ...
  interests: [
    ...
    {
      title: "Travel",
      description: "Exploring new countries and cultures is one of my greatest passions and sources of inspiration.",
