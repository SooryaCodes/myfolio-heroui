...
export const developerInfo: DeveloperInfo = {
  ...
  about: "A passionate developer and designer creating beautiful and functional digital experiences for clients worldwide.",
...
export const siteConfig: SiteConfig = {
  ...
  description: "Portfolio website featuring projects, skills, and services in web development and design.",
...
export const navItems = [
  ...
  { id: "marketplace", path: "/marketplace", label: "Market", icon: "FiShoppingBag" },
  { id: "contact", path: "/contact", label: "Contact", icon: "FiMessageCircle" }
]; 