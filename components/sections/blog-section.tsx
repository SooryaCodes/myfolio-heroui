      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-16 md:mb-24">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Latest Articles</h2>
        ...
        <div>
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-xl text-foreground font-semibold">Recent Articles</h3>
            <Link 
              as={NextLink}
              href="/blog" 
