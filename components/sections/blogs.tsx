...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Exploring the shift from minimalism to expressive design and what this means for creating engaging digital experiences in 2023.",
    date: "May 12, 2023",
    readTime: "8 min read",
    category: "Design",
    image:
  ...
  },
  {
    ...
    excerpt:
      "A deep dive into optimization techniques for React applications, from code splitting to memorization patterns.",
    date: "April 28, 2023",
  ...
  },
  {
    ...
    excerpt:
      "Going beyond WCAG compliance to create truly inclusive digital experiences that everyone can use and enjoy.",
    date: "March 15, 2023",
  ...
  },
  {
    ...
    excerpt:
      "How thoughtfully constructed design systems can streamline development, improve consistency, and enhance collaboration.",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive guide to creating stunning animations and interactions with Framer Motion in React applications.",
