...
export const Blogs = () => {
  ...
  return (
    <section id="blog" className="py-24 md:py-32 px-6 relative overflow-hidden bg-black">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-16 md:mb-24">
            ...
            <h2 className="heading-xl text-white mb-6">From the Blog</h2>
        ...
        {featuredPosts.length > 0 && (
          <div className="mb-16">
            <h3 className="text-2xl text-white font-semibold mb-8">Featured Articles</h3>
              ...
              {featuredPosts.map(post => (
                ...
                >
                  <motion.div 
                    ...
                    whileHover={{ y: -5 }}
                    onHoverStart={() => setHovered(post.id)}
                  ...
                  >
                    <div className="aspect-[16/9] relative overflow-hidden">
                      <Image 
                        ...
                        alt={post.title}
                        fill
                        className={`object-cover transition-transform duration-700 ${hovered === post.id ? 'scale-105' : 'scale-100'}`}
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent"></div>
                      
                      {/* Category badge */}
                      <div className="absolute top-4 left-4">
                        <div className="px-3 py-1 bg-primary/80 backdrop-blur-sm text-black text-xs font-medium rounded-full flex items-center gap-1.5">
                          <FiTag size={12} />
                          {post.category}
                        </div>
                      </div>
                    ...
                    <div className="p-6 lg:p-8">
                      ...
                      <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 group-hover:text-primary transition-colors">{post.title}</h3>
        ...
        <div>
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-xl text-white font-semibold">Latest Articles</h3>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-3">
                      <div className="px-2.5 py-0.5 bg-primary/10 text-primary text-xs font-medium rounded-full">
                        {post.category}
                      </div>
                    ...
                    <h3 className="text-lg font-bold text-white mb-2 line-clamp-2 group-hover:text-primary transition-colors">{post.title}</h3>
          ...
          <div className="text-center mt-12">
            <motion.button
              className="bg-black/30 border border-primary/30 text-primary hover:bg-primary/10 px-8 py-4 rounded-full font-medium inline-flex items-center gap-2"
              whileHover={{ y: -2 }}
