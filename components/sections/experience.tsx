...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Leading the development of user-facing features for Meta&apos;s new productivity suite. Focusing on accessibility, performance optimization, and elegant user experiences.",
    achievements: [
  ...
  },
  {
    ...
    duration: "2019 - 2022",
    description:
      "Designed and developed user interfaces for Shopify&apos;s merchant platform. Collaborated with product teams to create intuitive, efficient, and beautiful user experiences.",
    achievements: [
  ...
  },
  {
    ...
    duration: "2017 - 2019",
    description:
      "Provided end-to-end web development and design services for a range of clients, from startups to established businesses across various industries.",
    achievements: [
  ...
  },
  {
    ...
    duration: "2016 - 2018",
    description:
      "Specialized in human-computer interaction with a focus on user experience design and research methodologies. Thesis on gesture-based interfaces for immersive environments.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Active contributor to various open source projects in the React and design systems ecosystem. Focused on improving accessibility and developer experience.",
    achievements: [
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-16 md:mb-24">
            ...
            <h2 className="heading-xl dark:text-white text-gray-900 mb-6">
              Professional Journey
            </h2>
            <p className="dark:text-white/60 text-gray-600 max-w-2xl mx-auto">
              A curated timeline of my professional experience, education, and
        ...
        <div className="mb-12">
          <Tabs
            ...
            classNames={{
              tabList:
                "flex justify-center dark:bg-white/5 bg-black/5 backdrop-blur-sm rounded-full p-1 max-w-md mx-auto",
        ...
        <div className="relative mt-20">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-primary/50 via-primary/30 to-primary/5 hidden md:block" />
          ...
          {filteredExperiences.map((exp, index) => (
            ...
            >
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 top-1/2 w-5 h-5 bg-primary rounded-full z-20 border-4 border-white dark:border-black hidden md:block" />

              {/* Date badge - Centered on mobile, positioned on timeline for desktop */}
              <div
                className={`flex justify-center md:absolute md:top-1/2 md:-translate-y-1/2 md:w-auto z-10 
              ...
              <div className="md:grid md:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-3">
                          {exp.achievements.map((achievement, i) => (
                            <div
                              key={i}
                              className="glass-premium dark:bg-black/20 bg-white/70 p-3 rounded-lg border border-primary/5 dark:text-white/80 text-gray-700 text-sm flex items-start gap-3 transform transition-transform duration-300 hover:translate-x-1"
                            >
                ...
                <div
                  className={`hidden md:block ${index % 2 === 0 ? "md:order-2" : "md:order-1"} relative`}
                >
                  <RevealOnScroll
