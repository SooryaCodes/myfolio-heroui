...
const profileData = [
  ...
  {
    label: "Education",
    value: "Master's in HCI, University of Berlin",
    icon: <FiBookOpen className="text-primary" />,
  },
  {
    label: "Interests",
    value: "UI Design, Open Source, Photography",
...
export const About = () => {
  ...
  return (
    ...
    >
      {/* Background elements */}
      <div className="absolute inset-0 [background-size:30px_30px] [background-image:linear-gradient(to_right,rgba(var(--color-foreground),0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(var(--color-foreground),0.05)_1px,transparent_1px)] z-0" />
        ...
        <RevealOnScroll>
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-muted max-w-2xl mx-auto">
              A passionate developer and designer with a focus on creating
          ...
          >
            <motion.div variants={item}>
              <h3 className="text-3xl font-bold text-foreground mb-6">
                Hello! I&apos;m{" "}
                <span className="text-primary premium-highlight">
                  {developerName}
                </span>
                ,<br />a Developer & Designer based in {developerLocation}
              </h3>
            </motion.div>
            ...
            <motion.div variants={item}>
              <p className="text-muted mb-5">
                ...
                a combination of clean code and intuitive design. With over 5
                years of experience in the field, I&apos;ve helped businesses of
                all sizes transform their online presence and connect with their
            ...
            <motion.div variants={item}>
              <p className="text-muted mb-8">
                ...
                problem-solving. I believe in building solutions that are not
                just visually impressive, but also functional, accessible, and
                user-centered. Whether you need a stunning website, a complex
                web application, or a comprehensive digital strategy, I&apos;m
                ...
                <Card className="glass-premium border border-primary/10">
                  <CardBody className="flex flex-col items-center text-center p-6">
                    ...
                    <p className="text-muted text-sm">
                      Building responsive, performant, and accessible web
                      applications with modern frameworks and technologies.
                    </p>
                  </CardBody>
                </Card>
