          ...
          <CardBody className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {product.features.map((feature, index) => {
                ...
                const title = isFeatureObject
                  ? (feature as ProductFeature).title
                  : feature;
                const description = isFeatureObject
            ...
            <Accordion>
              {product.specifications && product.specifications.length > 0 ? (
                ...
                <AccordionItem
                  key="no-specs"
                  title={
                    <span className="text-foreground">No Specifications</span>
                  }
                >
            ...
            {product.requirements ? (
              <div className="space-y-6">
                {product.requirements.map(
                  (req: ProductRequirement, index: number) => (
                    <div key={index}>
