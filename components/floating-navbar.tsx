...
import { FiHome, FiGrid, FiCode, FiBriefcase, FiMessageCircle, FiLayers, FiStar, FiShoppingBag, FiSun, FiMoon, FiZap, FiUser } from "react-icons/fi";
...
export const FloatingNavbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const sections = ["hero", "about", "projects", "skills", "services", "experience", "testimonials", "marketplace", "blog", "contact"];
  ...
  return (
    ...
    >
        <div className="glass-premium rounded-full grid grid-cols-5 md:grid-cols-10 gap-1 md:gap-2 px-2 py-2 border border-border w-auto shadow-lg">
        {navItems.map((item) => (
          <div 
            key={item.id}
