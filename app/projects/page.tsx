      ...
      <div className="container mx-auto px-4 md:px-8 max-w-screen-2xl">
        ...
        <div className="max-w-6xl mx-auto text-center mb-20">
          ...
          <p className="text-foreground/70 text-lg md:text-xl mb-10 max-w-3xl mx-auto">
            Explore my recent projects and case studies. From web applications
            to mobile apps, these projects demonstrate my technical skills and
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {filteredProjects.map((project) => (
            <Card
              key={project.id}
              className="shadow-sm hover:shadow-lg transition-shadow border border-foreground/5"
            >
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-foreground/70 mb-8">
              No projects matching your selected category were found.
            </p>
            <Button
              color="primary"
              variant="flat"
